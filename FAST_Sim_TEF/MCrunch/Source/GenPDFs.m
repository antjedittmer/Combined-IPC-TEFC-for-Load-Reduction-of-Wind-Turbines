   ...
   % This function writes the PDFs to plain-text files.
      ...
      for File=0:NumFiles
         ...
         if ( File == 0 )
            ...
            fprintf( fid, '\nThe analysis was based upon %d rows from an aggregate of %d files.',  FileInfo.TotLines, NumFiles );
            fprintf( fid, [ '\n', repmat( [ StrFmt, '-x', StrFmt, '-y' ], 1, NumChans ), '\n' ], FileInfo.Names{[PDF.Chans;PDF.Chans]} );
            ...
            fprintf( fid, '\nThe analysis was based upon %d rows.',  FileInfo.NumLines(File) );
            fprintf( fid, [ '\n', repmat( [ StrFmt, '-x', StrFmt, '-y' ], 1, NumChans ), '\n' ], FileInfo.Names{[1:NumChans;1:NumChans]} );
   ...
   % Write the PDFs to an Excel workbook.
      ...
      for File=0:NumFiles
         ...
         for Ch=1:NumChans
            ...
            Info{6,Col+1}   = [ FileInfo.Names{PCh}, '-y' ];
