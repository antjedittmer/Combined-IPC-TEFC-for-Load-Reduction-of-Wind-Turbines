...
IPC_K_P    = 0 ;                                                               % 1.194213 0.524277
IPC_K_I    = 1; %1.194213;
IPC_K_D    = 0 ;
IPC_Switch = 'off';                                                         % 'on', 'off', oder 'variabel'
...
TEF_K_I    = 0 ;
TEF_K_D    = 0 ;
TEF_Switch = 'off' ;                                                      % 'on', 'off', oder 'variabel'
...
IPC_K_P    =  0.691554; %  %0.000354;                                                               % 1.194213 0.524277
IPC_K_I    = 1.194213; %0.631406; %0.658919;
IPC_K_D    = 0.000061;
IPC_Switch = 'off';                                                         % 'on', 'off', oder 'variabel'
IPC_ControllerType = "PID";                                                      % P, I, PI oder PID
...
WindfilePfad = "WindData\Eigene_Wind_Dateien\"; % Nicht ändern!
...
WindfilePfad = "WindData\Eigene_Wind_Dateien\TurbKlasseA\"; % Nicht ändern!
...
WindfilePfad = "WindData\Eigene_Wind_Dateien\TurbKlasseAnewSeed\"; % Nicht ändern!
...
WindfilePfad = "WindData\Eigene_Wind_Dateien\ohneTurbolenz\"; % Nicht ändern!
...
MeanWindspeedVec = [4:2:10,11:14,16:2:24,25];                                                         % Mittlere Windgeschwindigkeit als Integer zugehörig zu den Winddateien angeben
WindfilePfadUsed = "WindData\Eigene_Wind_Dateien\TurbKlasseAnewSeed\";

UserInputs.TEF.TEF_OLvalue       = 10;

for idx = 1: length(MeanWindspeedVec)
    MeanWindspeed= MeanWindspeedVec(idx);
    %MeanWindspeed = 16;
    %Loc_bts_file  = strrep(Loc_bts_file_54, aWind,num2str(MeanWindspeed));
    Loc_bts_file  = fullfile(WindfilePfad,[num2str(MeanWindspeed),'mps.bts']);
