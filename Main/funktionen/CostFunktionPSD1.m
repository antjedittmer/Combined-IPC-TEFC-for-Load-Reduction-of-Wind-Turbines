function [CostsOut] = CostFunktionPSD1(AnalysePSDout,AnalyseStatsout,AnalyseDELout,Testcase)
%COSTFUNKTIONPSD1 Summary of this function goes here
...
for i = 1 : length(fieldnames(AnalyseStatsout))                            % Loop ueber Windtestfaelle
    ...
    DELresults = AnalyseDELout.(sprintf('%s',Fieldnames(i))).results(IndexChannelgruppe,1).RelDeltaMax(TestcaseIndex);
